...
from collective.portlet.portlets import exampleportlet
from collective.portlet.portlets.tests.base_exampleportlet import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(IPortletType, name='collective.portlet.portlets.ExamplePortlet')
        self.assertEquals(portlet.addview, 'collective.portlet.portlets.ExamplePortlet')
    ...
    def test_invoke_add_view(self):
        ...
        self.failUnless(isinstance(mapping.values()[0], exampleportlet.Assignment))
...
class TestRenderer(TestCase):
    ...
    def test_render(self):
        # TODO: Pass any keywoard arguments to the Assignment constructor
        r = self.renderer(context=self.portal, assignment=exampleportlet.Assignment())
